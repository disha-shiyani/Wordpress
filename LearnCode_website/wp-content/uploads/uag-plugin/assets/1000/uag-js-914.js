document.addEventListener("DOMContentLoaded", function(){ jQuery(document).ready(function () {
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-a9d982e7");
				if ( scope.length ) { 
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-bb91337e");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
				...
				let scope = jQuery(".wp-block-uagb-image-gallery.uagb-block-55702820");
				if ( scope.length ) { 
					scope.css("visibility", "visible");
					let getSlickCarousel = scope.find(".uagb-slick-carousel");
					if( getSlickCarousel.length ) {
